...
| 预设名 | 技术栈 | 优先级 | 状态 |
|--------|--------|--------|------|
| react-vite | React + Vite + TypeScript | P0 | 基础完成 |
| vue-nuxt | Vue 3 + Nuxt 3 + TypeScript | P1 | 待开发 |
| node-api | Node.js + Express/Hono + TypeScript | P1 | 待开发 |
| base | 纯 TypeScript（无框架） | P1 | 待开发 |
...
| 版本 | 里程碑 | 状态 |
|------|--------|------|
| v0.1 | CLI 基础 + 规范体系 + React 预设 + 校验引擎 | 开发中 |
| v0.2 | 上下文同步 + Vue 预设 + 自动修复 | 计划中 |
| v0.3 | 迁移命令 + Node.js API 预设 + base 预设 | 计划中 |
